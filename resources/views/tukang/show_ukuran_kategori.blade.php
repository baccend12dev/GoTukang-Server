                    ...
                    <div class="nav-tabs-navigation">
                      <div class="nav-tabs-wrapper">
                        ...
                        <ul class="nav nav-tabs justify-content-end" data-tabs="tabs">
                          <li class="nav-item">
                            <a type="button" class="btn btn-primary" href="/data_tukang/show/kategori/edit/{{ $kategori->id_detail_kategori }}"><i class="material-icons">edit</i> Edit</a>
                          </li>
                          {{-- <li class="nav-item"> --}}
                            {{-- <a type="button" rel="tooltip" data-placement="bottom" title="Hapus Data" class="btn btn-primary ml-3" onclick="return confirm('Yakin ingin menghapus data ini?')" href="/data_tukang/show/ukuran/delete/{{ $kategori->id_detail_kategori }}"><i class="material-icons">delete</i> Detele</a> --}}

                            {{-- <a type="button" class="btn btn-primary ml-3" href="/data_tukang/add"><i class="material-icons">delete</i> Hapus Data</a> --}}
                          {{-- </li> --}}
                        </ul>
                      </div>
                    </div>
                    ...
                    <tbody>   
                        @foreach ($ukuran_kategori_tukang as $ukuran)
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                    {{-- <a type="button" rel="tooltip" data-placement="bottom" title="Lihat Data" class="btn btn-info" href="/data_tukang/show/{{ $data_tukang->id_tukang }}"><i class="material-icons">person</i></a> --}}
                                    <a type="button" rel="tooltip" data-placement="bottom" title="Hapus Data" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')" href="/data_tukang/show/ukuran/delete/{{ $ukuran->id_ukuran_detail_kategori }}"><i class="material-icons">close</i></a>
                                </td>
