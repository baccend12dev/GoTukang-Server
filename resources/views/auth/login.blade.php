        ...
        <div class="col-lg-6 col-md-6 ml-auto mr-auto mt-5">
          <div class="card card-login">
              <div class="card-header card-header-primary text-center">
                ...
                <a href="/"><h4 class="card-title">Login Admin GoTukang</h4></a>
                <hr>
                {{-- <br> --}}
                <div class="social-line">
                  <a href="https://github.com/ksmora" target="_blank" class="simple-text logo-normal">
                    <img src="{{ url('assets/img/icon_mesin_jahit.png') }}" alt="Go Tukang Logo" class="brand-image img-circle elevation-3" style="opacity: 1.0" width="140" height="140">
                  </a>
                </div>
                <br>
    ...
    <footer class="footer">
      <div class="container">
        ...
        <div class="copyright float-right">
          ...
          <a href="https://github.com/feronikanm" target="_blank">karyadi</a>
        </div>
      </div>
    </footer>
  </div>
