...
@section('page_name', 'Tambah Data Jenis')
        ...
        <div class="col-md-8">
          <div class="card">
              ...
              <div class="card-header card-header-tabs" data-background-color="purple">
                  <h4 class="card-title ">Tambah Data Jenis Pilihan</h4>
              </div>
          
                <form method="post" action="/data_jenis/store" enctype="multipart/form-data" class="form-horizontal">
                  {{ csrf_field() }}
                  ...
                  <div class="card-content">
                    ...
                    <div class="row">
                      <label class="col-sm-2 label-on-left">Nama Jenis</label>
                      <div class="col-sm-7">
                          <div class="form-group label-floating is-empty">
                              <input class="form-control" name="nama_jenis" type="text" placeholder="Nama Jenis"  autofocus />
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                    <label class="col-sm-2 label-on-left">Gambar Jenis</label>
                    ...
                    <div class="form-footer text-right">
                      ...
                      <a type="button" class="btn btn-white pull-fill" href="/data_jenis">Kembali</a>
