                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-tabs" data-background-color="purple">
                            ...
                            <div class="nav nav-tabs" data-tabs="tabs">
                                <span class="nav-tabs-title"><h4 style=" text-shadow: 0 2px 5px rgba(33, 33, 33, 0.5); ">Data Jenis Kebutuhan</h4></span>
                                <a type="button" class="btn btn-primary pull-right " href="/data_jenis/add"><i class="material-icons">add</i> Tambah Data</a>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <thead class=" text-primary">
                                ...
                                <th>Nama jenis</th>
                                <th class="text-center">Gambar Jenis</th>
                            ...
                            @endphp
                            <tbody>   
                                @foreach ($pilihjenis as $data_jenis)
                                    <tr>
                                        <td class="text-center">{{ $no++ }}</td>
                                        <td>{{ $data_jenis->nama_jenis }}</td>
                                        <td class="text-center">
                                            <img src="{{ url('img_pilihjenis/'.$data_jenis->gambar_jenis) }}" style="width: 120px; height: 120px; border-radius: 10px;" class="card-img-top mb-3" alt="...">
                                        </td>
                                        
                                        <td class="td-actions text-center">
                                            <a type="button" rel="tooltip" data-placement="bottom" title="Edit Data" class="btn btn-success" href="/data_jenis/edit/{{ $data_jenis->id_jenis }}"><i class="material-icons">edit</i></a>
                                            <a type="button" rel="tooltip" data-placement="bottom" title="Hapus Data" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')" href="/data_jenis/delete/{{ $data_jenis->id_jenis }}"><i class="material-icons">close</i></a>
                                        </td>
