                            ...
                            <div class="table-responsive">
                                <table id="datatables" class="table table-bordered table-striped">
                                    <thead class="text-primary">
                                        ...
                                        <th class="text-center" style="border-bottom: 1px solid rgb(117, 0, 146);">ID tukang</th>
                                        <th class="text-center" style="border-bottom: 1px solid rgb(117, 0, 146);">Nama tukang</th>
                                    ...
                                    <tbody>   
                                        @foreach ($penilaian as $data_penilaian)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $data_penilaian->id_tukang }}</td>                                
                                                <td class="text-center">{{ $data_penilaian->nama_tukang }}</td>
